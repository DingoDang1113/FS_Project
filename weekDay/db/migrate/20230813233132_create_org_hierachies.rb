class CreateOrgHierachies < ActiveRecord::Migration[7.0]
  def change
    create_table :org_hierachies do |t|
      ...
      t.string :org_level_one_id, null:false, index:{unique:true}
      t.string :org_level_two_id, null:false, index:{unique:true}
      t.string :org_level_three_id, null:false, index:{unique:true}
