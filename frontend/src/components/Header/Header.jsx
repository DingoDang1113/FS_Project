...
const Header = () => {
  ...
  const employee = useSelector(
    (state) => state?.entities.users && state.entities.users[userid]
  );
    ...
    <>
      {sidebar && (
        <div className="sidebar">
          ...
          <div className="side-icons">
            <button onClick={handleClick} value={"Sign Out"}>
              {" "}
              <span id="symbol-text">
                <FaSignOutAlt />
                Sign Out
      ...
      <header className="header-welcome">
        <div className="social">
          ...
          <div className="tooltip">
            <a
              href="https://www.linkedin.com/in/shalipeng/"
              target="_blank"
          ...
          <div className="tooltip">
            <a
              href="https://github.com/DingoDang1113"
              target="_blank"
              rel="noopener noreferrer"
              className="github"
            >
